...
ALTER TYPE "public"."partnership_model" OWNER TO "postgres";
...
ALTER TYPE "public"."partnership_tier" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_job_status_history"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_job_status_history"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_payment_on_completion"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_payment_on_completion"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_engineer_metrics"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_engineer_metrics"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."agencies" (
    ...
    "gstn" character varying(15) NOT NULL,
    "nsdc_code" character varying(50),
    "contact_person" character varying(255) NOT NULL,
    "phone" character varying(15) NOT NULL,
    "email" character varying(255) NOT NULL,
    "primary_location" "jsonb" NOT NULL,
    "service_areas" "text"[] DEFAULT '{}'::"text"[],
    "partnership_tier" "public"."partnership_tier" DEFAULT 'standard'::"public"."partnership_tier",
    "partnership_model" "public"."partnership_model" NOT NULL,
    "engineer_capacity" integer DEFAULT 0,
    "bank_account_name" character varying(255),
    "bank_account_number" "text",
    "bank_ifsc" character varying(11),
    "pan_number" "text",
    "status" "public"."agency_status" DEFAULT 'pending_approval'::"public"."agency_status",
    "onboarded_at" timestamp with time zone,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "valid_email" CHECK ((("email")::"text" ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'::"text")),
    CONSTRAINT "valid_gstn" CHECK ((("gstn")::"text" ~ '^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$'::"text")),
    CONSTRAINT "valid_phone" CHECK ((("phone")::"text" ~ '^\d{10,15}$'::"text"))
);
...
CREATE TABLE IF NOT EXISTS "public"."engineers" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "engineers_average_rating_check" CHECK ((("average_rating" >= (0)::numeric) AND ("average_rating" <= (5)::numeric))),
    CONSTRAINT "engineers_skill_level_check" CHECK ((("skill_level" >= 1) AND ("skill_level" <= 5))),
    CONSTRAINT "engineers_success_rate_check" CHECK ((("success_rate" >= (0)::numeric) AND ("success_rate" <= (100)::numeric))),
    CONSTRAINT "valid_email_engineer" CHECK ((("email" IS NULL) OR (("email")::"text" ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'::"text"))),
    CONSTRAINT "valid_phone_engineer" CHECK ((("phone")::"text" ~ '^\d{10,15}$'::"text"))
);
...
CREATE TABLE IF NOT EXISTS "public"."inspection" (
    ...
    "years_of_operation_in_equipment" integer,
    "years_of_operations" integer,
...
CREATE TABLE IF NOT EXISTS "public"."jobs" (
    ...
    "site_coordinates" "public"."geography"(Point,4326),
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "jobs_client_rating_check" CHECK ((("client_rating" >= 1) AND ("client_rating" <= 5))),
    CONSTRAINT "jobs_required_skill_level_check" CHECK ((("required_skill_level" >= 1) AND ("required_skill_level" <= 5))),
    CONSTRAINT "valid_client_phone" CHECK ((("client_phone")::"text" ~ '^\d{10,15}$'::"text"))
);
...
CREATE TABLE IF NOT EXISTS "public"."new_engineers" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "email" "text" NOT NULL,
    "phone" "text" NOT NULL,
...
ALTER TABLE "public"."new_engineers" OWNER TO "postgres";
...
ALTER TABLE "public"."new_jobs" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."agencies"
    ADD CONSTRAINT "agencies_gstn_key" UNIQUE ("gstn");
...
ALTER TABLE ONLY "public"."bids"
    ADD CONSTRAINT "bids_job_user_unique" UNIQUE ("job_id", "user_id");
...
ALTER TABLE ONLY "public"."engineers"
    ADD CONSTRAINT "engineers_phone_key" UNIQUE ("phone");
...
ALTER TABLE ONLY "public"."new_engineers"
    ADD CONSTRAINT "new_engineers_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."new_jobs"
    ADD CONSTRAINT "new_jobs_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_agencies_gstn" ON "public"."agencies" USING "btree" ("gstn");
...
CREATE INDEX "idx_agencies_type" ON "public"."agencies" USING "btree" ("type");



CREATE INDEX "idx_engineers_agency" ON "public"."engineers" USING "btree" ("agency_id");



CREATE INDEX "idx_engineers_availability" ON "public"."engineers" USING "btree" ("availability_status") WHERE ("availability_status" = 'available'::"public"."availability_status");



CREATE INDEX "idx_engineers_location" ON "public"."engineers" USING "gist" ("current_location");



CREATE INDEX "idx_engineers_phone" ON "public"."engineers" USING "btree" ("phone");
...
CREATE INDEX "idx_job_status_history_created" ON "public"."job_status_history" USING "btree" ("created_at");
...
CREATE INDEX "idx_jobs_agency" ON "public"."jobs" USING "btree" ("assigned_agency_id") WHERE ("assigned_agency_id" IS NOT NULL);
...
CREATE INDEX "idx_jobs_engineer" ON "public"."jobs" USING "btree" ("assigned_engineer_id") WHERE ("assigned_engineer_id" IS NOT NULL);
...
CREATE INDEX "idx_jobs_location" ON "public"."jobs" USING "gist" ("site_coordinates");



CREATE INDEX "idx_jobs_scheduled_time" ON "public"."jobs" USING "btree" ("scheduled_time");
...
CREATE INDEX "idx_notifications_agency" ON "public"."notifications" USING "btree" ("agency_id");
...
CREATE INDEX "idx_payments_agency" ON "public"."payments" USING "btree" ("agency_id");



CREATE INDEX "idx_payments_invoice_number" ON "public"."payments" USING "btree" ("invoice_number");
...
CREATE OR REPLACE TRIGGER "create_payment_trigger" AFTER UPDATE ON "public"."jobs" FOR EACH ROW EXECUTE FUNCTION "public"."create_payment_on_completion"();



CREATE OR REPLACE TRIGGER "job_status_change_trigger" AFTER UPDATE ON "public"."jobs" FOR EACH ROW EXECUTE FUNCTION "public"."create_job_status_history"();
...
CREATE OR REPLACE TRIGGER "update_engineer_metrics_trigger" AFTER UPDATE ON "public"."jobs" FOR EACH ROW EXECUTE FUNCTION "public"."update_engineer_metrics"();



CREATE OR REPLACE TRIGGER "update_engineers_updated_at" BEFORE UPDATE ON "public"."engineers" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."agencies"
    ADD CONSTRAINT "agencies_email_fkey" FOREIGN KEY ("email") REFERENCES "public"."users"("email");



ALTER TABLE ONLY "public"."bids"
    ADD CONSTRAINT "bids_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."new_jobs"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."engineers"
    ADD CONSTRAINT "engineers_agency_id_fkey" FOREIGN KEY ("agency_id") REFERENCES "public"."agencies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."engineers"
    ADD CONSTRAINT "engineers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id");
...
ALTER TABLE ONLY "public"."jobs"
    ADD CONSTRAINT "jobs_assigned_agency_id_fkey" FOREIGN KEY ("assigned_agency_id") REFERENCES "public"."agencies"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."jobs"
    ADD CONSTRAINT "jobs_assigned_engineer_id_fkey" FOREIGN KEY ("assigned_engineer_id") REFERENCES "public"."engineers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."new_jobs"
    ADD CONSTRAINT "new_jobs_assigned_fkey" FOREIGN KEY ("assigned") REFERENCES "public"."users"("id");
...
ALTER TABLE ONLY "public"."payments"
    ADD CONSTRAINT "payments_agency_id_fkey" FOREIGN KEY ("agency_id") REFERENCES "public"."agencies"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."surveys"
    ADD CONSTRAINT "surveys_agency_id_fkey" FOREIGN KEY ("agency_id") REFERENCES "public"."agencies"("id");



ALTER TABLE ONLY "public"."surveys"
    ADD CONSTRAINT "surveys_engineer_id_fkey" FOREIGN KEY ("engineer_id") REFERENCES "public"."engineers"("user_id");



ALTER TABLE ONLY "public"."surveys"
    ADD CONSTRAINT "surveys_job_number_fkey" FOREIGN KEY ("job_number") REFERENCES "public"."jobs"("job_number") ON DELETE CASCADE;
...
GRANT ALL ON FUNCTION "public"."create_job_status_history"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_job_status_history"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_job_status_history"() TO "service_role";



GRANT ALL ON FUNCTION "public"."create_payment_on_completion"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_payment_on_completion"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_payment_on_completion"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_engineer_metrics"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_engineer_metrics"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_engineer_metrics"() TO "service_role";
...
GRANT ALL ON TABLE "public"."inspection" TO "anon";
GRANT ALL ON TABLE "public"."inspection" TO "authenticated";
GRANT ALL ON TABLE "public"."inspection" TO "service_role";
...
GRANT ALL ON TABLE "public"."new_engineers" TO "anon";
GRANT ALL ON TABLE "public"."new_engineers" TO "authenticated";
GRANT ALL ON TABLE "public"."new_engineers" TO "service_role";



GRANT ALL ON TABLE "public"."new_jobs" TO "anon";
GRANT ALL ON TABLE "public"."new_jobs" TO "authenticated";
GRANT ALL ON TABLE "public"."new_jobs" TO "service_role";
